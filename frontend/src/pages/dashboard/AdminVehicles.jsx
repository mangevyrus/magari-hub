                        ...
                        <div className="space-y-3 p-5">
                            ...
                            {[1, 2, 3, 4].map(
                                (item) => (
                                    <div
                                        key={item}
                                        className="h-24 animate-pulse rounded-xl border border-[#8B1A1A]/10 bg-[#FDF8F5]"
                                    />
                                )
                            )}
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Link
                                            ...
                                            className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#8B1A1A]/20 bg-[#FDF8F5] text-[#6A5A4A] transition hover:border-[#8B1A1A] hover:bg-[#8B1A1A] hover:text-white"
                                            title="View"
                                        >
                                            <Eye size={16} />
                                        </Link>
...
function StatusBadgeRed({ status }) {
    const styles = {
        available:
        ...
        draft:
            "bg-[#FDF8F5] text-[#8A7A6A] border border-[#8B1A1A]/10",
