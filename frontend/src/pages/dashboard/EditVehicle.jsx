...
function EditVehicle() {
    ...
    if (loading) {
        ...
        return (
            ...
            <div className="flex min-h-screen items-center justify-center bg-[#F5F9FC]">
                ...
                <div className="flex items-center gap-3 text-[#12395B]">
    ...
    if (!vehicle) {
        ...
        return (
            ...
            <div className="flex min-h-screen items-center justify-center bg-[#F5F9FC] p-5">
                ...
                <div className="rounded-2xl border border-red-100 bg-white p-8 text-center shadow-sm">
                    ...
                    <Link
                        to="/admin/vehicles"
                        className="mt-6 inline-flex rounded-xl bg-[#12395B] px-5 py-3 font-bold text-white"
                    >
                        Back to Vehicles
                    </Link>
                ...
                <div className="mx-auto max-w-7xl px-5 py-6 md:px-8">
                    ...
                    <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div>
                            ...
                            <Link
                                to="/admin/vehicles"
                                className="mb-3 inline-flex items-center gap-2 text-sm font-bold text-[#2F80C0] hover:text-[#12395B]"
                            >
                ...
                >
                    ...
                    <section className="mt-6 rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                        ...
                        <textarea
                            ...
                            rows={7}
                            className="mt-6 w-full rounded-xl border border-blue-100 bg-[#F5F9FC] px-4 py-3 text-sm outline-none transition focus:border-[#2F80C0] focus:ring-4 focus:ring-blue-100"
                    ...
                    <section className="mt-6 rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                        ...
                        <label className="flex cursor-pointer items-center justify-between gap-5">
                            ...
                            <input
                                ...
                                className="h-5 w-5 accent-[#2F80C0]"
                            />
                    ...
                    <section className="mt-6 rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                        ...
                        {vehicle.images?.length ? (
                                ...
                                {vehicle.images.map(
                                    image => (
                                        ...
                                        <div
                                            ...
                                            className="group relative overflow-hidden rounded-2xl border border-blue-100 bg-[#F5F9FC]"
                                        >
                                            ...
                                            {image.is_primary && (
                                                ...
                                                <div className="absolute left-3 top-3 flex items-center gap-1 rounded-full bg-[#12395B] px-3 py-1.5 text-xs font-bold text-white">
                                            ...
                                            <div className="absolute inset-x-0 bottom-0 flex gap-2 bg-gradient-to-t from-black/70 to-transparent p-3 pt-10">
                                                ...
                                                {!image.is_primary && (
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-bold text-[#12395B] transition hover:bg-[#EAF6FF] disabled:opacity-50"
                                                    >
                            ...
                            <div className="mt-6 rounded-xl border border-dashed border-blue-200 bg-[#F8FCFF] py-12 text-center">
                    ...
                    <section className="mt-6 rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                        ...
                        <label className="mt-6 flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-blue-200 bg-[#F8FCFF] px-5 py-12 text-center transition hover:border-[#2F80C0] hover:bg-[#EAF6FF]">
                            ...
                            <p className="mt-4 font-extrabold text-[#12395B]">
                        ...
                        {newImages.length > 0 && (
                            ...
                            <>
                                    ...
                                    {newImages.map(
                                        (
                                            ...
                                            <div
                                                ...
                                                className="relative overflow-hidden rounded-xl border border-blue-100"
                                            >
                                ...
                                <button
                                    ...
                                    className="mt-5 inline-flex items-center gap-2 rounded-xl bg-[#2F80C0] px-5 py-3 font-bold text-white transition hover:bg-[#12395B] disabled:cursor-not-allowed disabled:opacity-50"
                                >
                    ...
                    <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                        ...
                        <Link
                            to="/admin/vehicles"
                            className="inline-flex items-center justify-center rounded-xl border border-blue-100 bg-white px-6 py-3.5 font-bold text-[#12395B] transition hover:bg-[#F5F9FC]"
                        >
                            Cancel
                        </Link>
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#12395B] px-7 py-3.5 font-bold text-white shadow-lg shadow-blue-900/10 transition hover:bg-[#2F80C0] disabled:cursor-not-allowed disabled:opacity-50"
                        >
